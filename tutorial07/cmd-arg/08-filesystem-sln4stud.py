...
parser.add_argument("--text", help="hledaný řetězec", default=config['text'])
parser.add_argument("--soubor_out", help="soubor pro uložení výstupu", default=config['soubor_out'])
